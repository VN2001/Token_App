...
const GoogleIcon = () => (
  <Svg width="28" height="28" viewBox="0 0 48 48">
    <Path
      fill="#EA4335"
      d="M24 9.5c3.5 0 6.6 1.2 9 3.2l6.7-6.7C35.7 2.5 30.2 0 24 0 14.8 0 6.9 5.4 3 13.3l7.8 6C12.7 13.1 17.9 9.5 24 9.5z"
    />
    <Path
      fill="#4285F4"
      d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v8.5h12.7c-.6 3-2.3 5.5-4.8 7.2l7.6 5.9C43.7 37.5 46.5 31.4 46.5 24.5z"
    />
    <Path
      fill="#FBBC05"
      d="M10.8 28.7A14.6 14.6 0 0 1 9.5 24c0-1.6.3-3.2.8-4.7l-7.8-6A24 24 0 0 0 0 24c0 3.9.9 7.5 2.5 10.8l8.3-6.1z"
    />
    <Path
      fill="#34A853"
      d="M24 48c6.2 0 11.4-2 15.2-5.5l-7.6-5.9c-2 1.4-4.6 2.2-7.6 2.2-6.1 0-11.3-3.6-13.2-9.1l-8.3 6.1C6.9 42.6 14.8 48 24 48z"
    />
...
const PillInput = ({ errorStyle, ...props }) => (
  <View style={[s.shadowWrap, errorStyle]}>
    <TextInput
      style={[
        s.input,
        errorStyle && { borderColor: "#FF5A5A", borderWidth: 1.5 },
      ]}
...
const s = StyleSheet.create({
  ...
  loginBtn: {
    ...
    alignItems: "center",
    width: rs(200), // full width like Register screen
    alignSelf: "center",
    marginBottom: vs(26),
    shadowColor: "#7B5FEB",
    shadowOpacity: 0.38,
  ...
  divRow: {
    ...
    justifyContent: "center",
    marginBottom: vs(18),
    paddingHorizontal: rs(20), // equal padding both sides = centered
  },
